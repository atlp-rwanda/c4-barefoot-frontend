...
import {
  getAccommodations,
  getAccommodation,
  getAccommodationAminity,
} from "../../src/redux/actions/fetchAccommodations";
import {
  accommodationsPayload,
  accommodationAminitiesPayload,
} from "../../dummyData";
...
describe("Fetch accommodations actions", () => {
  ...
  it("Get accommodation with thier aminities successfully", () => {
    mock
      .onGet(`${URL}/accommodations/2121222`)
  ...
  it("Get accommodation with thier aminities failed", () => {
    ...
    store
      .dispatch(getAccommodationAminity(2121222))
      .then((res) => {
        const action = [
          {
            type: "FETCH_AMENITIES_SUCCESS",
