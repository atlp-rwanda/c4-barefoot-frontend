...
import { createLocation } from "../../redux/actions/createLocationAction";
    ...
    <MuiThemeProvider muiTheme={getMuiTheme()}>
      ...
      <Snackbar open={this.props.LocationSates.successOpen} autoHideDuration={6000} onClose={this.handleClose} >
        <this.Alert onClose={this.handleClose} severity="success" >
          Success: {this.props.LocationSates.successMessage ? 'Location created successfully' : 'Message Not set'}
        </this.Alert>
      </Snackbar>
...
const decoratedComponent = connect(mapStateToProps,{createLocation})(CreateLocation);
export default reduxForm({ form: "CreateLocation" }) (decoratedComponent)
