...
import {PersonAddOutlined, PersonOutlined, MailOutline} from '@material-ui/icons'
import SideDrawer from './SideDrawer'

const navLinks = [
    {title: 'Login', path: '/login'},
    {title: 'Signup', path: '/signup'},
    {title: 'Send Email', path: '/forgetpassword'}
]
            ...
            <Container maxWidth='lg' className={classes.navDisplay}>
                ...
                <Hidden smDown>
                    <List component='nav'>
                        ...
                        <Button href="/forgetpassword" color='inherit' startIcon = { <MailOutline/> }>Send Email</Button>
                    </List>
                </Hidden>
                <Hidden mdUp>
